...
class App {
  ...
  createMedias(
    ...
    const defaultItems = [
      { image: picture1, text: "Macaquilla" },
      { image: picture2, text: "Chancla" },
      { image: picture3, text: "Chula" },
      { image: picture4, text: "Preciosa" },
      { image: picture5, text: "Divina" },
      { image: picture6, text: "Encantadora" },
      { image: picture7, text: "Love u" },
      { image: picture8, text: "Love x2" },
      { image: picture9, text: "Loquilla" },
      { image: picture10, text: "Chismosilla" },
      { image: picture11, text: "Magestuosa" },
      { image: picture12, text: "Increible" },
      { image: picture13, text: "Mi mujer" },
      { image: picture14, text: "Wasaski" },
      { image: picture15, text: "Quejonsilla" },
      { image: picture16, text: "Te amo" },
      { image: picture17, text: "Animo" },
      { image: picture20, text: "Chiquitapreciosa" },
      { image: picture21, text: "bb" },
      { image: picture22, text: "love u x3" },
      { image: picture23, text: "Mujer preciosa" },
      { image: picture24, text: "lesgo" },
    ];
